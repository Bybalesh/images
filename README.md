...
[Backlog CMG](./backlog/Backlog#Генерация МК ( App/CompetenceMatrixGenerator/Описание работы Competence Matric Generator (CMG) CMG )
[Backlog ETG](./backlog/Backlog#Генерация тестовых заданий (ETG))
[Backlog RMG](./backlog/Backlog#Генерация маршрута обучения (RMG))
[Backlog COMMON](./backlog/Backlog#Общие (COMMON))
